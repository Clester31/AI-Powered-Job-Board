...
import { IsBreakpoint } from "@/components/isBreakpoints";
...
import { getJobListingApplicationIdTag } from "@/features/jobListings/JobListingApplications/cache/JobListingApplications";
    ...
    <>
      ...
      >
        ...
        <IsBreakpoint
          ...
          otherwise={
            <ClientSheet>
              <SheetContent hideCloseButton className="p-4 overflow-y-hidden">
    ...
    return (
      <Popover>
        ...
        <PopoverContent className="flex flex-col gap-2">
          ...
          <Button asChild>
            <Link href="/user-settings/resume">Upload</Link>
          </Button>
        </PopoverContent>
      </Popover>
    );
    ...
    <Dialog>
      ...
      <DialogContent className="md:max-w-3xl max-h[calc(100%-2rem)] overflow-hidden flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Applying for a job cannot be undone and is something that can only
            be done once per job listing
          </DialogDescription>
        </DialogHeader>
