                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      ...
                      value={field.value ?? ""}
                      className="min-h-32"
                      placeholder="Describe the jobs you're interested in. For example: 'I'm looking for remote frontend development positions that user React and pay at least $100k per year."
                    />
                  </FormControl>
                  <FormDescription>
