...
import { formatExperienceLevel, formatJobListingLocation, formatJobType, formatLocationRequirement, formatWage } from "@/features/jobListings/lib/formatters";
              ...
              >
                ...
                <div className="mb-5">
                    {getBadges(jobListing).map((badge, index) => (
                        <div key={index} className="inline-block rounded-md border-solid border font-medium w-fit text-accent-foreground text-sm px-3 py-1 mb-1 mr-1">
                            {badge}
                        </div>
                    ))}
                </div>
